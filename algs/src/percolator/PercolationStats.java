...
public class PercolationStats {
	...
	public double confidenceLo() {
		return mean() - STD_NORMAL_DEVIATE * Math.sqrt(stddev())
	...
	public static void main(String[] args) {
		...
		System.out.println("95% Confindence Low: " + perkyStats.confidenceLo());
		System.out
				.println("95% Confindence High: " + perkyStats.confidenceHi());
	}
}
